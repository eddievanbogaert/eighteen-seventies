...
Open research questions, by chapter. Each one is phrased as something a source
must answer. That phrasing is the point: a question written as "did X happen in
February?" invites an agent to supply a remembered yes, while "what date does
the source give for X, and what is the source?" can only be closed by opening
a book.

Nothing here is answered from recall. When a question is closed, replace it
with a `CLAIMS.md` row and delete it from this file, or leave it with the
answer and the `source_key` attached if the reasoning is worth keeping.

Questions that turn out to be unanswerable from available sources are not
failures. Record them as gaps, and say so in the chapter — see the "absence of
a source is content" note in `AGENTS.md`.

## Cross-cutting

- **QX-1** What is the book's rule for calendar discrepancies? Several 1870s
  events in Russia, the Ottoman Empire, and Japan are dated differently in
  different sources depending on the calendar in use. Which convention does
  the book adopt, and where is it stated to the reader?
- **QX-2** What currency conversion practice does the book use, if any? Are
  period sums given in period currency only, or accompanied by a modern
  equivalent — and if the latter, whose index?
- **QX-3** For each of the four threads, what is the single best synthetic
...
- **Q01-1** What start and end dates does the standard account give, and does
  it treat the Paris Commune as inside the war or after it?
- **Q01-2** What were the financial terms imposed on France, in what currency,
  and on what schedule of payment?
- **Q01-3** What is the documented connection, if any, between those payments
  and the German currency reform of the early 1870s? This is the hinge between
  the empire and money threads and it cannot rest on an assumed link.
- **Q01-4** How do French and German historiographies differ on the war's
  causes, and is that difference still live or now settled?

## Q02 — Darwin, The Descent of Man

- **Q02-1** What is the full title, publisher, and publication date of the
...
- **Q02-4** What was the reception in the periodical press in 1871, and is
  there a source that samples it systematically rather than anecdotally?

## Q03 — Chicago Rebuilt

- **Q03-1** What does the best source give for the fire's extent, duration,
  death toll, and number displaced — and what is the uncertainty on each?
- **Q03-2** What did the rebuilding actually change about how tall buildings
  were built, and on what evidence? The received story compresses decades of
  structural innovation into a few years.
- **Q03-3** Who paid? What share of losses was insured, how many insurers
  failed, and what does that imply for the money thread?
- **Q03-4** What happened to the people burned out of the city, as against the
  property? Sawislak treats this; what does she find about relief and class?
- **Q03-5** What is the documented origin of the cow story, and when did it
  enter the record?

## Q04 — Butler, Erewhon

- **Q04-1** What is the publication history: first edition date, publisher,
  anonymity or not, and what changed in the revised edition?
- **Q04-2** What is the relationship between the "Book of the Machines"
  chapters and Butler's earlier published writing on the same idea?
- **Q04-3** Was the book read as satire of Darwin, homage to him, or something
  else, and what did Butler himself say about that?
...
- **Q05-1** What was the corporate structure of the arrangement, stated plainly
  enough for a general reader, and which source explains it best?
- **Q05-2** What is the documented sequence: when the scheme operated, when the
  press exposed it, when Congress investigated, when it acted?
- **Q05-3** Which individuals were named, which were formally censured or
  cleared, and on what evidence in each case? One verified row per name.
- **Q05-4** How much money is involved, by whose accounting, and does the
  accounting differ between sources?
- **Q05-5** What did the scandal change, if anything, in law or practice? A
  scandal with no consequences is a different chapter than one with them.
...
- **Q06-3** Which of the connections the plot depends on had opened in the
  years just before — and what are the documented opening dates?
- **Q06-4** Which English translation should the book quote, and what are the
  known deficiencies of the early ones?
- **Q06-5** How did the novel handle the imperial infrastructure it moves
  through, and is there a critical literature on that? Relevant if this
  chapter is to carry any weight beyond its home thread.

## Q07 — The Coinage Act of 1873

- **Q07-1** What does the statute say, section by section, on silver? Get the
  text into `/primary`.
...
- **Q07-4** What was happening to world silver production and price in the
  years around the act, and does the causation run from the act to the price or
  the reverse?
- **Q07-5** Which other countries changed monetary standard in the same
  years, and is there a source treating these as one connected episode rather
  than separate national stories?

## Q08 — The Comstock Act

- **Q08-1** What is the act's formal title and statutory citation, and what
  does the text prohibit in its own terms?
- **Q08-2** What enforcement powers did it create, and what office did Comstock
  himself hold under it?
- **Q08-3** What is the documented record of prosecutions in the 1870s — how
  many, for what, with what outcomes? Beisel and Werbel both treat this; do
  their figures agree?
- **Q08-4** What was the state-law and postal-regulation landscape before the
...
- **Q09-1** What death-toll range do the major accounts give, how do they
  differ, and why? Lane and Keith are the two book-length treatments.
- **Q09-2** What was the disputed local election that produced the standoff,
  and what does the source record of it consist of?
- **Q09-3** What was the federal prosecution, what statute was charged, and how
  did the case end?
- **Q09-4** What did the resulting Supreme Court decision hold, and what is the
  scholarly argument about its consequences for federal enforcement?
- **Q09-5** What Black accounts of the massacre survive, in what form, and
  where? The chapter should not rest solely on the record left by the side
  that did the killing.
- **Q09-6** When did the event's name change in usage from "riot" to
  "massacre," and is there a source that documents that shift?

## Q10 — The Panic of 1873

- **Q10-1** What is the documented trigger sequence in September 1873, and how
  do accounts differ on the causal chain?
- **Q10-2** Which railroad and banking failures preceded the panic, and what
  does the best source say about whether they caused it or shared its cause?
- **Q10-3** What is the European side — the Vienna and Berlin events earlier
  that year — and is there a source treating the crisis as one transatlantic
  event?
- **Q10-4** How long did the contraction last, by whose dating, and by what
  measure? The conventional length is contested.
- **Q10-5** What unemployment estimates exist for the mid-1870s United States,
  who constructed them, and from what evidence? No figure enters the draft
